          ...
          <div className="col-span-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredHackathons.map(hackathon => (
                <div key={hackathon.id} className="border rounded-lg p-6 shadow-md flex flex-col">
                  {/* Title and Status */}
                  ...
                  <p className="text-sm text-gray-600">Organizer: <span className="font-mono">{hackathon.creatorId}</span></p>
                  <p className="text-sm text-gray-600">👥 {hackathon.participants} participants</p>

                  <div className="mt-3">
                    <p className="text-sm text-gray-600">📅 Reg. by {hackathon.subDeadline}</p>
                  </div>

                  <div className="mt-3 border-t pt-3 text-center font-semibold text-blue-500 cursor-pointer">
                    View details →
                  </div>
                </div>
              ))}
